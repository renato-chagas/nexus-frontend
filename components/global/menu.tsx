...
import { Box, LayoutDashboard, Users, Tag, Book, History, GitBranch} from "lucide-react";
...
export function Menu() {
  ...
  return (
    <aside className="flex flex-col items-center w-[240px] max-w-[240px] h-full bg-gray-200" style={{ boxShadow: "0 -0px 6px -1px rgba(0,0,0,0.1)"}}>
      ...
      <div className="p-6 bottom-0 w-full text-gray-500 border-gray-400" style={{ boxShadow: "-4px 0px 6px -1px rgba(0,0,0,0.1)"}}>
